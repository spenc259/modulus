 ...
 * Tween JS
 */
function ip_tween_scripts()
{
	wp_enqueue_script('tween', get_template_directory_uri() . '/assets/js/intimation/tween.js', array(), false, true);
	wp_enqueue_script('tween-src', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.1/TweenMax.min.js', array(), false, false);
}

add_action('wp_enqueue_scripts', 'ip_tween_scripts');
